...
//
//Modifications by greatwanz: Combined crunch project and example1 project provided 
...
public:
	...
	static bool check_for_option(int argc, const char *argv[], const char *pOption)
	{
	...
	static int main_internal(int arg, const char *argv[])
	{
